...
![Illustration](content/img/Earthbreaker.png)
...
Quando effettui un attacco senz'armi contro una creatura nel tuo turno, puoi usare un'azione bonus per effettuare un altro attacco senz'armi contro la stessa creatura.

Il tuo immenso potere mette a dura prova la maggior parte delle armi, frantumandole. Quando colpisci con un attacco in mischia con un'arma non magica, l'arma si rompe nella tua mano e non può essere usata per effettuare attacchi finché non viene riparata. 
...
- *Campo Repulsivo.* Condensi una bolla di gravità intorno a te. La prossima volta che una creatura ti colpirebbe con un attacco in mischia, la bolla scoppia in una fragorosa esplosione. Ogni creatura entro10ft da te deve superare un tiro salvezza su Forza o essere spinta fino a 10ft lontano da te. Se questo spinge l'attaccante oltre la sua portata, l'attacco ti manca. Se la bolla non scoppia entro l'inizio del tuo prossimo turno, si dissolve innocuamente.
- *Pestaggio.* Pestando il terreno, provochi un terremoto distruttivo in una linea di 10ft sul terreno, con origine da te. Ogni creatura nell'area deve superare un tiro salvezza su Destrezza o subire 1d4 danni contundenti e avere svantaggio al suo prossimo tiro salvezza su Forza prima dell'inizio del tuo prossimo turno, poiché viene sbilanciata. Inoltre, il terreno in quell'area diventa terreno difficile finché non viene ripulito. Ogni porzione di 5ft quadrati dell'area richiede almeno 1 minuto per essere ripulita manualmente.
...
![Illustration](content/img/Galvanic.png)
